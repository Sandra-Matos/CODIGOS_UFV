...
int main()
{
    ...
    if (N <= 2000)
    {
        ...
        printf("O sexo do(a) aluno(a) e: %lf\n", (int)matriz[alunomaior][1]);
        printf("A media do curso 1 foi: %lf\n", media1);
        printf("A media do curso 2 foi: %lf\n", media2);
        printf("A media do curso 3 foi: %lf\n", media3);
        printf("A media do curso 4 foi: %lf\n", media4);
        printf("A media do curso 5 foi: %lf\n", media5);
    }
